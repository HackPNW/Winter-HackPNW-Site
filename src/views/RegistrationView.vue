<template>
  <div
    ...
    <div class="flex flex-col mt-12 w-full max-w-xl gap-y-4 p-6">
      <!-- START FORM -->
      <div
        class="ring-2 rounded-md px-2 text-gray-700 font-semibold mt-8 bg-amber-200">
        Hey there, unfortunately due to reaching capacity limits, only those who
        have been invited to join an existing team are able to sign up. If you
        do not have a team code you are no longer able to sign up for HackPNW.
        If you would like to stay up to date with future hackathons join our
        mailing like
        <a
          @click="goToMailingList"
          class="cursor-pointer hover:bg-gray-300 bg-gray-200 rounded-md px-1 text-sky-500"
          >here</a
        >
      </div>
